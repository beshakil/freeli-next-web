...
const TaskPropertiesCon = ({ setTaskPropertiesPopup }) => {
    ...
    const handleTrackHourPopupOpen = () => {
        setTrackHourPopup(true);
    }

    const handleTrackHourPopupClose = () => {
    ...
    return (
        <>
                                ...
                                <div className="secound_section quickTask">
                                    <div className="left_part">
                                        <div className="track_form_div">
                                            ...
                                            <div className="track_hoursArea" onClick={handleTrackHourPopupOpen}>
                                                <div className="notes_label_area">
            ...
            {
                trackCostPopup && <TrackCostPopup
                    handleTrackCostPopupClose={handleTrackCostPopupClose} />
            }
            {
                trackHourPopup && <TrackHourPopup
                    handleTrackHourPopupClose={handleTrackHourPopupClose} />
            }
        </>
    );
};
